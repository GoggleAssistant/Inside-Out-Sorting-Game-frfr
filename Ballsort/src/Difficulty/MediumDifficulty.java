...
public class MediumDifficulty {
    ...
    public MediumDifficulty(JPanel tubePanel) {
        ...
        tubes = new JPanel[7]; // Update to accommodate 7 tubes
        tube1 = new int[5];
        tube2 = new int[5];
        tube3 = new int[5];
        tube4 = new int[5];
        ...
        tube7 = new int[5];
        heldBall = -1;
        ballDispenser = new int[25]; // Change the size to accommodate 5 of 1's, 5 of 2's, 5 of 3's, 5 of 4's, and 5 of 5'
        
        // Fill the ballDispenser with 5 of each integer 1 to 5
        int index = 0;
        for (int i = 1; i <= 5; i++) {
    ...
    public void graphics() {
        // Calculate starting X position to center 7 tubes
        int totalWidth = 7 * 105 + 6 * 10; // 7 tubes and 6 gaps
        int startX = (tubePanel.getWidth() - totalWidth) / 2;
        
        // Create 7 tubes and buttons
        for (int i = 0; i < 7; i++) {
            // Create tube panel
            tubes[i] = new JPanel();
    ...
    public void printTubes() {
        for (int i = 0; i < 7; i++) { // Update to print all 7 tubes
    ...
    public void displayBalls() {
        ...
        for (int i = 0; i < 7; i++) { // Update to loop through all 7 tubes
    ...
    public void gameStart() {
        ...
        for (int tubeIndex = 0; tubeIndex < 7; tubeIndex++) { // Update to loop through 7 tubes
            for (int j = 0; j < 5; j++) {
                if (!ballList.isEmpty()) {
    ...
    public void gameLogic() {
        ...
        System.out.println("MediumDifficulty game logic executed.");
    }
}